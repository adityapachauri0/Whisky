...
const Buy: React.FC = () => {
  ...
  const whiskeys = [
    ...
    },
    {
      ...
      age: '25 Years',
      price: 75000,
      image: '/images/shop-bottle-4.webp',
    ...
    },
    {
      ...
      age: '16 Years',
      price: 12500,
      image: '/images/shop-bottle-10.webp',
                ...
                <div className="card-luxury h-full flex flex-col">
                  ...
                  <div className="relative h-80 overflow-hidden bg-gradient-to-b from-rich-brown/50 to-primary-black/50">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                      <button className="btn-secondary transform translate-y-8 group-hover:translate-y-0 transition-transform duration-500">
                        Quick View
                      </button>
                    </div>
                  </div>
