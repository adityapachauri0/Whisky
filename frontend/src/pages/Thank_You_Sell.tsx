  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Thank you for your cask submission. We'll provide a valuation within 48 hours." />
      </Helmet>
