...
// Get all consultations (admin only - add auth middleware in production)
router.get(
  '/',
  // authMiddleware.requireAdmin, // Uncomment in production
  consultationController.getAllConsultations
);

// Update consultation (admin only - add auth middleware in production)
router.patch(
  '/:id',
  // authMiddleware.requireAdmin, // Uncomment in production
...
router.get(
  '/reminders/upcoming',
  // authMiddleware.requireSystem, // Uncomment in production
